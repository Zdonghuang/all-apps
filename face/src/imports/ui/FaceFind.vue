        ...
        <div class="content">
            <div>
                ...
                <div class="right">
                    ...
                    <img src="./find3.png" alt="" :class="move?'in':'ins'">
                    <div :class="move?'mask':'masks'"></div>
                    <div class="font" v-show="success">
                        <p>识别成功！</p>
                        <span>备注信息：</span>
                        <span class="msg">{{msg?msg:'无'}}</span>
                    </div>
            ...
            <div>
                <button class="btn" @click="check">人脸查找</button>
            </div>
            <!-- <div class="booth">
...
export default {
    ...
    methods:{
        ...
        check(){
            ...
            this.form.append('method', 'rl_findrl');
                ...
                if(res.status==200){
                    if(res.data.code!='10000'){
                        ...
                        if(back.error_code==0){
                            ...
                            _this.success=true;
                            _this.fail=false;
                            _this.msg=back.result.user_list[0].user_info;
                        }else{
                            this.move=false;
                            _this.fail=true;
                            _this.success=false;
