<template>
    <div class="home">
        ...
        <div class="content">
                ...
                <div class="right">
                    ...
                    <div class="font" v-if="success">
                        ...
                        <div style="text-align:left">
                            ...
                            <p>是否打伞：{{info.umbrella.name}}</p>
                            <p>方向：{{info.orientation.name}}</p>
                            <p>人体：{{info.is_human.name}}</p>
                            <p>帽子：{{info.headwear.name}}</p>
                            <p>性别：{{info.gender.name}}</p>
                            <p>年龄：{{info.age.name}}</p>
                            <p>眼镜：{{info.glasses.name}}</p>
                            <p>背包：{{info.bag.name}}</p>
                            <p>吸烟：{{info.smoke.name}}</p>
                            <p>是否有交通工具：{{info.vehicle.name}}</p>
                        </div>
                    </div>
            ...
            <div>
                <button class="btn" @click="check">人体属性</button>
            </div>
            <!-- <div class="booth">
...
export default {
    ...
    methods:{
        ...
        check(){
            ...
            this.form.append('method', 'rt_attr');
            ...
            _this.$ajax.post('https://api.ileapcloud.com/jdapi/bdapi/use',this.form).then((res)=>{
                ...
                if(res.status==200){
                    if(res.data.code!='10000'){
                        ...
                        _this.fail=false;
                        _this.msg=back;
                        _this.info=back.person_info[0].attributes;
                        _this.move=false;
                    }
                }
            })
